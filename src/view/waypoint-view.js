...
import {humanizeTaskDueDate, getTimeDifference} from '../utils/point.js';
import {DATE_FORMAT} from '../const.js';

function createOfferEventTemplate({title, price}) {
  return (
...
function createWayPointView (eventPoint, destination, offers) {
  const {basePrice, type, dateFrom, dateTo, isFavorite} = eventPoint;
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <ul class="event__selected-offers">
          ${offers.map((offer) => createOfferEventTemplate(offer)).join('')}
        </ul>
...
export default class WayPointView extends AbstractView {
  ...
  constructor({eventPoint, destination, offers, onEditClick, onFavoriteClick}) {
    super();
